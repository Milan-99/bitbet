...
import { Button, IconButton, useModal, AddIcon, Image } from 'kebabfinance-uikit'
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  const isOldPasta = stakingTokenName === QuoteToken.KEBAB
  ...
  return (
    <Card isActive={isCardActive} isFinished={isFinished}>
      ...
      <div style={{ padding: '24px' }}>
        ...
        <Label isFinished={isFinished} text={TranslateString(330, `${earnToken} earned`)} />
        <StyledCardActions>
